...
export default function Container(props: ContainerProps) {
  ...
  const meta = {
    ...
    description: `Experienced graphic designer and visual storyteller.`,
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://www.Nouhaila.codes${router.asPath}`}
        />
        <link
          rel="canonical"
          href={`https://www.Nouhaila.codes${router.asPath}`}
        />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Nouhaila" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="Nouhaila" />
